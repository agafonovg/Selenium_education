...
class TestRegistration(unittest.TestCase):
    ...
    def __check(self, remote: webdriver.Remote):
        first_required = remote.find_element_by_css_selector("div.first_block .form-control.first")
        second_required = remote.find_element_by_css_selector("div.first_block .form-control.second")
        third_required = remote.find_element_by_css_selector("div.first_block .form-control.third")
        ...
        WebDriverWait(remote, 3).until(lambda x: x.find_element_by_tag_name("h1"))
        ...
        self.assertEqual(expect, welcome_text, f"{welcome_text} is not {expect}")
